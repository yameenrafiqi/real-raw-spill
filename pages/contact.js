      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          <a
            ...
            className="border-4 border-black p-6 md:p-8 bg-white hover:bg-yellow-400 transition-all transform hover:scale-105 group"
            onClick={(e) => {
              e.preventDefault();
          ...
          >
            <div className="flex flex-col items-center text-center">
              <svg className="w-12 h-12 md:w-16 md:h-16 mb-4 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <h3 className="font-black text-lg md:text-xl mb-2">EMAIL</h3>
              <p className="font-mono text-xs md:text-sm break-all">syednayer@rawspill.com</p>
            </div>
          </a>
          ...
          >
            <div className="flex flex-col items-center text-center">
              <svg className="w-12 h-12 md:w-16 md:h-16 mb-4 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
              <h3 className="font-black text-lg md:text-xl mb-2">LINKEDIN</h3>
              <p className="font-mono text-xs md:text-sm">Connect with me</p>
            </div>
          </a>
        </div>
        ...
        <div className="mb-16">
          <div className="bg-yellow-400 border-4 border-black p-8 md:p-12 text-center">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-6xl font-black mb-4">
                SCHEDULE A MEETING
              </h2>
              <p className="text-lg md:text-xl font-mono mb-8 text-black">
                Want to connect directly? Book a time slot that works for you!
              </p>
              ...
              <div className="bg-white border-4 border-black p-6 mb-6">
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  <h3 className="text-2xl font-black">BOOK YOUR SLOT</h3>
                </div>
                
                <div className="space-y-4 text-left font-mono text-sm md:text-base">
                  <div className="flex items-start gap-3">
                    ...
                    <span>15-30 minute sessions available</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>Video call or phone - your choice</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>Confirmation sent to syednayer@rawspill.com</span>
                  </div>
                </div>
              </div>

              <a
                href="https://calendly.com/syednayer-rawspill"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-8 py-4 bg-black text-white font-black text-lg border-4 border-black hover:bg-white hover:text-black transition-all transform hover:scale-105"
              >
                OPEN CALENDAR →
              </a>
              
              <p className="mt-6 text-sm font-mono text-gray-700">
                You'll be redirected to my calendar page to choose a time
              </p>
            </div>
          </div>
          
          <div className="text-center mt-8">
            <p className="text-2xl font-black text-gray-600 mb-2">OR</p>
            <p className="font-mono text-gray-600">Send me a message below</p>
          </div>
        </div>

        {/* Contact Form Section */}
        <div className="bg-black text-white border-4 md:border-8 border-yellow-400 p-6 md:p-12">
          <h2 className="text-3xl md:text-7xl font-black mb-8 md:mb-12 text-center">
            SEND A <span className="text-yellow-400">MESSAGE</span>
          </h2>
          
          {/* Contact Info */}
          <div className="grid md:grid-cols-2 gap-6 mb-8 md:mb-12">
            <div className="border-4 border-yellow-400 p-4 md:p-6 bg-black">
              <div className="flex items-center mb-2">
                <svg className="w-6 h-6 md:w-8 md:h-8 text-yellow-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="font-black text-yellow-400 text-base md:text-lg">EMAIL</span>
              </div>
              <a href="mailto:syednayer@rawspill.com" className="font-mono text-sm md:text-base text-white hover:text-yellow-400 transition break-all">
