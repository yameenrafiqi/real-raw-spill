    ...
    <Layout>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {/* Email */}
          <a
            href="mailto:syednayer016@gmail.com"
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="font-mono text-sm break-all">syednayer016@gmail.com</p>
            </div>
          </a>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-black text-xl mb-2">GITHUB</h3>
              <p className="font-mono text-sm">View my code</p>
            </div>
          </a>
        </div>
